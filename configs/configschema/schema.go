...
type Block struct {
	...
	// decoderSpec is a the value returned by DecoderSpec. It is generated by
	// the first call to DecoderSpec, and saved for subsequent calls.
	// decoderSpec must always be access while holding the decoderSpecMutex lock.
	decoderSpec hcldec.Spec
}
